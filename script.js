...
document.querySelector(".tombol").addEventListener('click', function () {
 ...
 Terima kasih kau masih mau bersamaku, kau yang membuat hariku menjadi lebih berwarna dan bermakna bahkan sangat istimewa.
...
bahkan kau juga selalu berkorban untukku. Tidak hanya itu, kau yang selalu mengajarkanku apa arti dari sebuah kesabaran.
 Suka duka telah kita lalui bersama. Terima kasih banyak semoga tuhan membalas kebaikan yang telah kau lakukan☺').then(function () {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya ${sender} juga kangen ${nama} :((`).then(function () {
                          Swal.fire('Terakhir deh yaa').then(function () {
